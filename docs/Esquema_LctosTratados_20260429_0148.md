...
**Gerado:** 2026-04-29 | **Revisão:** v2 — schema 13 colunas, data_compra, titular/final_cartao separados  
**Fonte da verdade:** este documento prevalece sobre Esquema_LctosTratados_20260429_0035.md
...
| 2 | ID_Lote             | Texto    | Sim    | Identificador único do lote, gerado automaticamente no formato `{EMISSOR}-{AAAAMMDD}-{HHMMSS}`. | `SA-20260429-014800` |
...
| 6 | Tipo                | Texto    | Sim    | Classificação do lançamento. Domínio: `Compra à vista`, `Compra parcelada`, `Pagamento`, `Outros`. | `Compra parcelada` |
