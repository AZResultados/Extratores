...
**Revisão:** v3 — adição A14 (VBA temporário / lógica em Python) e referência ao NFR-01  
**Fonte da verdade:** este documento prevalece sobre Checkpoint_Sinc_20260428_1600.md
...
└── docs/
    ├── SDD/
    │   ├── Requiriments_20260428_1614.md
    │   ├── Design_Doc_20260428_1614.md
...
| A13 | Descriptografia centralizada em src/pdf_decrypt.py — nenhum extrator com lógica própria de abertura de PDF protegido |
| A14 | VBA é camada de conveniência temporária — toda lógica de negócio em Python; qualquer lógica no VBA vira retrabalho garantido na migração para banco de dados (NFR-01) |
...
gerado: 2026-04-28 | fonte: Design_Doc_1614 + Tasks_1530 + SnapShot_0100 + Checkpoint_1600
